...
const CONFIG = {
  ...
  STARTER_LOGO: 'public/images/starter/logo/avatar.svg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: 'public/images/starter/logo/avatar.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg

  // MENU ， 菜单部分不在此处配置，请在Notion数据库中添加MENU

  // 英雄区块导航
  STARTER_HERO_ENABLE: true, // 开启英雄区
  STARTER_HERO_TITLE_1: '水木易的个人网站', // 英雄区文字
  STARTER_HERO_TITLE_2: '终身学习者｜中华国学探索者｜产品经理 ｜哲学硕士', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '项目作品', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL:
    'https://shuimuyi.com', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '找到我', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://shuimuyi.com', // 英雄区按钮
